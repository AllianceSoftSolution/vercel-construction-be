...
export declare const getVendorAccountStatement: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const addVendorPayment: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const getVendorPayments: (req: Request, res: Response, next: import("express").NextFunction) => void;
